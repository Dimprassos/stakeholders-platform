...
// (/events/[slug]/sponsors). Groups published sponsors by their package tier.
...
export function SponsorGrid({ sponsors }: { sponsors: SponsorWithPackage[] }) {
  ...
  const groups = new Map<string, SponsorWithPackage[]>();
